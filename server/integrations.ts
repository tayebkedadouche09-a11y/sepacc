...
export function getStaticIntegrationReports(): IntegrationReport[] {
  ...
  return [
    base("database", "Database (MySQL)", dbOk, ["DATABASE_URL"], dbOk ? "DATABASE_URL is set. Connectivity is verified on demand." : "No DATABASE_URL. Catalog, orders, and deliveries cannot persist."),
