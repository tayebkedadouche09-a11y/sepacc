...
export const ENV = {
  ...
  oAuthServerUrl: first(process.env.OAUTH_SERVER_URL),
  ...
  planetscaleServiceToken: first(process.env.PLANETSCALE_SERVICE_TOKEN),
  planetscaleServiceTokenId: first(process.env.PLANETSCALE_SERVICE_TOKEN_ID),
  planetscaleOrg: first(process.env.PLANETSCALE_ORG),
